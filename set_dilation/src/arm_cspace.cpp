...
//     //vector<Point> triangle_1_angles = calculate_2dof_multiple_joint_angles(Point(), triangle_1, {joint_1_length, joint_2_length});
...
//     //vector<Point> square_1_angles = calculate_2dof_multiple_joint_angles(Point(), square_1, {joint_1_length, joint_2_length});
