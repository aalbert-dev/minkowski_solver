...
int main()
{
    ...
    vector<Point> circle_1_angles = calculate_multiple_joint_angles(Point(), circle_1, {joint_1_length, joint_2_length});
    Point goal_1{2, 3};
    Point start_1{2, 1};
    Point goal_1_angles = calculate_joint_angles(Point(), goal_1, joint_1_length, joint_2_length);
    Point start_1_angles = calculate_joint_angles(Point(), start_1, joint_1_length, joint_2_length);
...
//     vector<Point> triangle_1_angles = calculate_multiple_joint_angles(Point(), triangle_1, {joint_1_length, joint_2_length});
//     Point goal_1{2, 3};
//     Point start_1{2, 1};
//     Point goal_1_angles = calculate_joint_angles(Point(), goal_1, joint_1_length, joint_2_length);
//     Point start_1_angles = calculate_joint_angles(Point(), start_1, joint_1_length, joint_2_length);
...
//     vector<Point> square_1_angles = calculate_multiple_joint_angles(Point(), square_1, {joint_1_length, joint_2_length});
//     Point goal_1{2, 3};
//     Point start_1{2, 1};
//     Point goal_1_angles = calculate_joint_angles(Point(), goal_1, joint_1_length, joint_2_length);
//     Point start_1_angles = calculate_joint_angles(Point(), start_1, joint_1_length, joint_2_length);
